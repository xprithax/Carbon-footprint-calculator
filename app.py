...
# LOAD GEOJSON FILE
with open("/Users/manavisrani07/Documents/projects_to_pub/gw_project/Carbon-Footprint-Calculator-App/data/countries.geojson") as response:
    countries = json.load(response)

# LOAD TEMPERATURE DATA
df_raw = load_data(path="/Users/manavisrani07/Documents/projects_to_pub/gw_project/Carbon-Footprint-Calculator-App/data/temp_gdppc.csv")
df = deepcopy(df_raw)

# LOAD EMISSIONS DATA
df_e_raw = load_data(path="/Users/manavisrani07/Documents/projects_to_pub/gw_project/Carbon-Footprint-Calculator-App/data/TOT_EMpc_DF.csv")
df_e = deepcopy(df_e_raw)

# LOAD SDG DATA
all_sorted_raw = load_data(path="/Users/manavisrani07/Documents/projects_to_pub/gw_project/Carbon-Footprint-Calculator-App/data/all_sorted.csv")
